...
if __name__ == '__main__':
    ...
    try:
        ...
        try:
            ...
            DataArray = {
                "chat_id": TG_USER_ID,
                "text": str("总共"+str(len(invited_pin) + len(success_pin)) + "个Pin成功助力。\\n原有"+str(len(invited_pin)) + "个Pin成功助力。%0A"+str(invited_pin)+"。%0A新增"+str(len(success_pin)) + "个Pin成功助力。%0A"+str(success_pin))
            }
            PostIndex = 0
